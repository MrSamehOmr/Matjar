...
namespace DataAccessLayer
{
    ...
    public class DBHandler
    {
        ...
        public DBHandler()
        {
            string datasource_1 = "DataSource = E:\\WorkSpace\\Programing\\Desktop\\CSharp\\Matjar - Copy\\Matjar\\bin\\Debug\\data\\matjar.db";
            //string datasource_2 = "DataSource = data\\matjar.db";
            connection = new SQLiteConnection(datasource_1);
            connection.Open();
        }
